...
# %% auto 0
__all__ = ['images_from_paths', 'embed_images', 'embed_images_for_df']
...
def embed_images_for_df(df: daft.DataFrame, model_name: str, batch_size: int) -> daft.DataFrame:
    """
    ...
    return df.with_column("embeds", daft.lit(embeds_series))
