...
# %% auto 0
__all__ = ['BATCH_SIZE', 'MODEL_NAME', 'images_df', 'paths', 'embeds', 'dl_hf_images']

# %% ../../nbs/011_prepare-images.ipynb 3
...
# %% ../../nbs/011_prepare-images.ipynb 7
...
# %% ../../nbs/011_prepare-images.ipynb 9
...
# %% ../../nbs/011_prepare-images.ipynb 11
...
paths = [Path(i["img_path"].lstrip("file:/")) for i in images_df.select("img_path").to_pylist()]
