...
# %% auto 0
__all__ = ['MIN_BYTES', 'validations', 'validate_images', 'split_on_condition', 'size_nontrivial', 'array_not_oblong',
...
validations: list[Callable[[daft.DataFrame], daft.DataFrame]] = [size_nontrivial, img_not_oblong, img_name_distinct]

validate_images = partial(do_validations, validations=validations)
